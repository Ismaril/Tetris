...
namespace Tetris
{
    public class Sprites
    {
        ...
        /// <summary>
        /// Collection of lists. Each sublist contains 4 different images of a tetromino single block. Sublists are called based on which level is current player on. Based on that, the color of tetromino blocks change.
        /// </summary>
